...
export default function Login() {
  ...
  return (
   ...
   <li></li>
    ...
    <div class="card">
  <div class="card2">
    <form class="form" onSubmit={handleLoginClick} method='post'>
      ...
      <div class="field">
        ...
        <input type="password" class="input-field" placeholder="Password" value={password} onChange={handlePasswordChange} title='Passoword need 8 character one capital letter,number and special character' />
      </div>
      <div class="btn">
